...
def email_response(name, critical_phrase_list, list_of_extracted_phrases, AWS_Comprehend_Sentiment_Dump):
    # Function Constants
    SENDER_NAME = 'Edmund Dotsey' # Type in Your Full Name to be used in the response email body.
...
def lambda_handler(event, context):
    ...
    db_response = table.put_item(Item={'ResponsesID': rid,  # <--- Insert the correct variable
                                       'Name': event['name'],  # <--- Insert the correct variable
                                       'Email': event['email'],  # <--- Insert the correct variable
                                       'Cell': event['phone'],  # <--- Insert the correct variable
                                       'Message': event['message']  # <--- Insert the correct variable
                                       })
    # -----------------------------
    ...
    # --- Insert your code here ---
    SENDER = 'edmundped@gmail.com' #Add your AMAZON SES Verified Email Here
    # -----------------------------
    ...
    SUBJECT = f"Data Science Portfolio Project Website - Hello {event['name']}"
    # -------------------------------
